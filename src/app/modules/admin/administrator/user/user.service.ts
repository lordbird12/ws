...
*/
    ...
    creaete(data: FormData): Observable<DataUser> {
    ...
    create(data: any): Observable<any> {
        return this._httpClient.post<any>(environment.API_URL + 'api/user', data, { headers: this.httpOptionsFormdata.headers });
    }
    ...
    getuserpage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.get(environment.API_URL + '/api/user/page?page=1&limit=100&filter.status=$eq:1', dataTablesParameters).pipe(
            switchMap((response: any) => {
                return of(response);
            })
        );
